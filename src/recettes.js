...
const recettes = {
    ...
    recette3: {
        nom: 'Cari crevette',
        img: 'crevettes.jpg',
        ingredients: '700g de crevettes ou de gambas, 3 tomates, 5 échalottes, 4 gousses d\'ail,1 morceau de gingembre, 2 pincées de curcuma',
        instructions: "Nettoyez les crevettes, incisez le dos afin de retirer le boyau et décortiquez\nEmincez les échalotes, pilez l'ail et le gingembre avec le sel, hachez finement les tomates.\nChauffez votre marmite (ou faitout) sur un feu très vif.\nLorsque elle est très chaude, versez-y les crevettes sans aucune matière grasse et retirez-les quand elles deviennent toutes rouges.\nMettez alors de l'huile et faites revenir les échalotes émincées jusqu'à ce qu'elles fondent mais sans coloration.\nAjoutez le mélange ail gingembre et sel, ensuite les tomates et 2 pincées de curcuma. Couvrez 5 min à feu très doux pour obtenir une sauce.\nLorsque les épices sont fondues, ajoutez les crevettes et un peu d'eau qui couvre juste l'ensemble et une branche de thym\nLaissez réduire à feu vif mais en laissant tout de même une sauce, c'est à ce moment qu'on rajoute le piment pour ceux qui aiment."
